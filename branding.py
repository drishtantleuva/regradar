...
[data-testid="stTabs"] button[role="tab"][aria-selected="true"] { color: #7c2d3a; }
[data-testid="stIconMaterial"] { font-family: 'Material Symbols Rounded' !important; }
div[data-testid="stExpander"] { border: 1px solid #ddd9cc; border-radius: 3px; background: #faf9f5; }
.stButton button { border-radius: 3px; border: 1px solid #c8c1ad; background: #faf9f5; color: #7c2d3a; }
.stButton button:hover { border-color: #7c2d3a; }

.masthead-rule { height: 3px; background: #7c2d3a; width: 54px; margin: 6px 0 4px; }
.eyebrow {
  text-transform: uppercase; letter-spacing: 0.2em; font-size: 0.72rem;
  color: #7c2d3a; font-weight: 600;
}
...
.answer {
  ...
  border-left: 3px solid #7c2d3a; padding: 4px 0 4px 18px; margin: 8px 0 4px;
}
...
.passage .cite {
  ...
  text-transform: uppercase; letter-spacing: 0.06em; color: #7c2d3a;
}
...
.dl-step b { color: #7c2d3a; font-family: 'Libre Baskerville', serif; }
.dl-step .n {
  display: inline-block; font-family: 'Libre Baskerville', serif; font-weight: 700;
  color: #7c2d3a; font-size: 1.5rem; margin-bottom: 4px;
}
a { color: #7c2d3a; }
